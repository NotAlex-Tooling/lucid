 ...
 *
 * Caches the app shell and runtime dependencies so Lucid works offline
 * after one online session. The shell is served network-first so fresh
 * code always wins online; allowlisted CDN assets are cache-first.
 */
